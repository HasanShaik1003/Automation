...
public class EmployeeHomePage {
    ...
    //Objects
    @FindBy(xpath = "//div[text()='Chloe Nelson ']")
    ...
    @FindBy(xpath = "//div[text()='Request has been submitted']")
    private WebElement leaveRequestSubmitSuccessMessage;
    ...
    public String retrieveProfileName() {
        ...
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated((By.xpath("//div[text()='Chloe Nelson ']"))));
    ...
    public String retrieveLeaveRequestSubmitSuccessMessage() {

        String successMessage = leaveRequestSubmitSuccessMessage.getText();
